  ...
  if (!client) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-gray-400 bg-gray-50/50 ring-1 ring-foreground/10">
        ...
        <p className="text-xs mt-1">Choose a client from the directory to view account details</p>
      </div>
    );
  }
        ...
        {!collapsedSections.creditSettings && (
          <div className="space-y-0">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <span className="text-xs font-semibold text-gray-900">Net 30</span>
            </div>
            <Separator />
            <div className="flex items-center justify-between py-2">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-xs font-semibold text-gray-900">
                  {utilizationPercent > 80 ? "High" : utilizationPercent > 60 ? "Medium" : "Low"}
                </span>
              </div>
            </div>
            <Separator />

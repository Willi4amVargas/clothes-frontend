            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700 block">System Language</label>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700 block">Timezone</label>
                  <select className="w-full h-9 rounded-md border border-slate-200 bg-white px-3 text-sm">
                ...
                <div className="pt-2 border-t border-slate-100 space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-700">Desktop Push Alerts</span>
                    <input type="checkbox" className="h-4 w-4 rounded border-slate-300 text-primary focus:ring-primary" defaultChecked />
                  </div>
                </div>
              </div>
